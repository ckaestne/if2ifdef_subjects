...
public class DeferredWriteTest extends TestBase {
    ...
    public void testTempEvictionAndObsoleteCounting()
        ...
        /* 
         * Set the default size of the log file on Android to 10M, and the JE 
         * test data can be stored in one .jdb file, so the assertTrue 
         * statement will not throw AssertionFailedError.
         */
        if (EnvironmentImpl.IS_DALVIK) {
            envConfig.setConfigParam(EnvironmentParams.LOG_FILE_MAX.getName(),
                                     Integer.toString(10000000));
        }
        env = new Environment(envHome, envConfig);
