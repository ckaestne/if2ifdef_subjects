...
public class DbBackupTest extends TestBase {
     ...
     * except in Java 6. There's no way to clean up a read-only directory.
     */
    public void XXtestReadOnly()
        throws Exception {
    ...
    private void verifyDb(String saveDirName, boolean rename)
        ...
        if (useMultiEnvDirs) {
            ...
            verifyDbPart2(saveDirName, rename);
        } else {
    ...
    private void verifyDbPart2(String saveDirName, boolean rename)
        throws DatabaseException {
