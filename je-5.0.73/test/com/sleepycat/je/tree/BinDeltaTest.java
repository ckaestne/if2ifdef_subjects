...
public class BinDeltaTest extends TestBase {
    ...
    public void testSimple()
        ...
        try {
            ...
            assertEquals(fullLsn, bin.getLastFullVersion());
            assertEquals(fullLsn, bin.getLastLoggedVersion());
            assertEquals(DbLsn.NULL_LSN, bin.getLastDeltaVersion());
    ...
    private void logAndCheck(BIN targetBIN)
         ...
         * Log it as a delta.
         */
        final long fullLsn = targetBIN.getLastFullVersion();
        final long deltaLsn;
        targetBIN.latch();
        try {
        ...
        assertEquals(deltaLsn, targetBIN.getLastDeltaVersion());
        assertEquals(deltaLsn, targetBIN.getLastLoggedVersion());
        assertEquals(fullLsn, targetBIN.getLastFullVersion());
