...
public class UtilizationTest extends CleanerTestBase {
    ...
    public void testReuseKnownDeletedSlotDup()
        ...
        /* Verify that file2 is still obsolete. */
    ...
    public void testInsertDup()
        ...
        expectObsolete(file1, false); // 2nd LN
    ...
    /**
     * In addition to the restrictions in expectObsoleteLNSizeCounted, we do
     * not expect the size counted to always be accurate if dups are
     * configured, because we evict the LN after writing a dup.
     */
    private boolean expectAccurateObsoleteLNSize() {
        return expectObsoleteLNSizeCounted() && !dups;
    }
