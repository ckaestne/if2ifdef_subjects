...
public class PingCommandTest extends MonitorTestBase {
    ...
    public void testMissedAddGroupChangeEvents()
        ...
        assertEquals(0, listener.groupAddEvents);
        assertEquals(0, listener.joinGroupEvents);

        /* 
         * Await from here in case node 5 fires immediately after enabling 
         * events notification. 
         */
        listener.groupBarrier = new CountDownLatch(5);
        ...
        assertEquals(5, listener.groupAddEvents);

        listener.awaitEvent(listener.joinGroupBarrier);
        assertEquals(5, listener.joinGroupEvents);
    }
    ...
    public void testMissedRemoveGroupChangeEvents()
        ...
        listener.awaitEvent(listener.joinGroupBarrier);
        listener.awaitEvent(listener.groupBarrier);
        assertEquals(1, listener.joinGroupEvents);
        assertEquals(1, listener.groupAddEvents);
        ...
        assertEquals(0, listener.groupRemoveEvents);
        ...
        monitor.disableNotify(false);
        listener.awaitEvent(listener.groupBarrier);
        assertEquals(4, listener.groupRemoveEvents);
    }
    ...
    public void testMissedJoinGroupEvents()
        ...
        assertEquals(groupSize, listener.joinGroupEvents);
    }
    ...
    public void testAbnormalClose()
        ...
        assertEquals(groupSize, listener.leaveGroupEvents);
    }
    ...
    public void testKillReplicas()
         ...
         * new process.
         */ 
        File envHome = new File(envRoot, "rep" + groupSize + 1);
        envHome.mkdir();
         ...
         */
        assertEquals(groupSize + 1, listener.joinGroupEvents);

        /* Expect to detect an abnormally LeaveGroupEvent. */
        assertEquals(1, listener.leaveGroupEvents);
