...
public class HardRecoveryTest extends TestBase {
    ...
    public void testHardRecoveryDeadHandle()
        ...
        try {
            ...
            /*
             * WaitForNode2 is a latche that will help us know when node2 has
             * finished it syncup with node 3, after force node 3 to become a
             * master. Node1 will simply throw a
             * MasterReplicaTransitionException before syncing up.
             */
            ...
            /*
             * At this point, node 1 should have thrown a
             * MasterReplicaTransitionException and node 2 should have thrown a
