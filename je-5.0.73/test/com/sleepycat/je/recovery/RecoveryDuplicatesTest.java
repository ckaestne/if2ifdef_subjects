...
public class RecoveryDuplicatesTest extends RecoveryTestBase {
    ...
    public void testSR11455()
        ...
        try {
            ...
            /*
             * JE uses a transaction in the constructor SyncDB, so the
             * transaction ID increases by 1, and this test opens Environment
             * twice, so the expected transaction ID is 8.
             */
            assertEquals(8, txn.getId());
            txn.commit();
            env.close();
