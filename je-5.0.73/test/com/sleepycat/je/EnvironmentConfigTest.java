...
public class EnvironmentConfigTest extends TestBase {
    ...
    public void testSerialize()
        ...
        envConfig.setCacheModeStrategy
            (new MyCacheModeStrategy(CacheMode.DEFAULT));
        ...
        assertEquals(newConfig.getCacheModeStrategy().getCacheMode(),
                     envConfig.getCacheModeStrategy().getCacheMode());
    ...
    private static class MyCacheModeStrategy implements CacheModeStrategy {
        private CacheMode cacheMode;

        public MyCacheModeStrategy(CacheMode cacheMode) {
